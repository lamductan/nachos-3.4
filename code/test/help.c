...
int main() {
  ...
  PrintString("  1. PrintString ASCII table\n");
  PrintString("  2. Sort an array with has n elements from the user’s input ( n at most equals to 100). This function uses Bubble Sort algorithm to sort this array.\n");
  Exit(0);
}
